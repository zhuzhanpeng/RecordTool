package com.onairm.baselibrary.net.download;


import com.onairm.baselibrary.net.download.DownLoadListener.DownloadInterceptor;
import com.onairm.baselibrary.net.exception.HttpTimeException;
import com.onairm.baselibrary.net.exception.RetryWhenNetworkException;
import com.onairm.baselibrary.net.subscribers.ProgressDownSubscriber;
import com.onairm.baselibrary.net.utils.NetUtil;
import com.onairm.baselibrary.net.utils.DbDownUtil;
    ...
    public void startDown(final DownInfo info) {
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .baseUrl(NetUtil.getBasUrl(info.getUrl()))
                    .build();
