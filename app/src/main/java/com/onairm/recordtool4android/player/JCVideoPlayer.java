package com.onairm.recordtool4android.player;
...
//        textureView.setRotation(-90);
        /*textureView.setScaleX((float) 1.5);
        textureView.setScaleY((float) 1.5);*/
...
*/
    ...
    public void onPrepared() {
        if(null != this.onPreparedListener){
            onPreparedListener.onPrepared(JCMediaManager.instance().mediaPlayer);
        }
